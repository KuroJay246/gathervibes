...
- [ ] **Phase 17G-B2**: Firestore Rules Real Deploy + Immediate Smoke — in progress on branch `codex/phase-17g-b2-firestore-rules-real-deploy-immediate-smoke`; Firestore rules deployed, Firestore indexes not deployed, admin smoke verified, scanner smoke pending
