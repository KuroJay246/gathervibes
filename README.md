...
Phase 17E-A is the current review-only phase for Access workflow rules and data model readiness. It does not implement a live approval workflow, revoke workflow, staff assignment editing workflow, lead-scanner permission, Firestore rules deploy, or Firestore indexes deploy.
