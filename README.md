...
No live approval/revoke workflow exists yet, and no live lead-scanner permission exists yet. The next recommended subphase is Phase 17D-C Access & Roles read-only/admin UI foundation only, if organizer approval is given for that later follow-on phase.
