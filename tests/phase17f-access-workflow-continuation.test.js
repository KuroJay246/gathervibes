...
test('17F status copy keeps 17E-C/D/E read-only and records current-head Daily QA success as non-blocking', async () => {
  ...
  assert.match(settings, /Phase 17G-A Live Workflow Go\/No-Go Review \+ Rules Deployment Approval Package only/)
  assert.match(settings, /Organizer decision after Phase 17G-A/)
  assert.match(settings, /Choose 17G-B dry-run final review only, 17G-C disabled requester create workflow, or 17G-D disabled admin review workflow/)
  ...
  assert.match(health, /Phase 17G-A remains approval-only with no rules or index deploy/)
  ...
  assert.match(readme, /Phase 17G-A is now active on branch `codex\/phase-17g-a-live-workflow-go-no-go-rules-approval-package` from main commit `8801419fb580d7430bf9c29e31807bd6ef4d80e9` as a Live Workflow Go\/No-Go Review \+ Rules Deployment Approval Package only\./)
  ...
  assert.match(handoff, /Phase 17G-A is now active on branch `codex\/phase-17g-a-live-workflow-go-no-go-rules-approval-package` from main commit `8801419fb580d7430bf9c29e31807bd6ef4d80e9` as a Live Workflow Go\/No-Go Review \+ Rules Deployment Approval Package only\./)
...
test('Phase 17G-A approval package stays non-live and documents the rules deployment boundary', async () => {
  ...
  assert.match(artifact, /Status: active approval package only/)
