...
test('17F status copy keeps 17E-C/D/E read-only and records current-head Daily QA success as non-blocking', async () => {
  ...
  assert.match(settings, /Closed after organizer review PASS \/ final review accepted \/ no Firestore rules deploy \/ no Firestore index deploy \/ no live workflow/)
  ...
  assert.match(health, /Phase 17G-A closed after organizer review PASS with no rules or index deploy, and Phase 17G-B closed after organizer review PASS with no new deploy\./)
