...
test('Phase 17E-B docs and status copy describe accessRequests as a closed dry-run prototype only', async () => {
  ...
  assert.match(qa, /Phase 17E-C is active as a read-only admin request surface, Phase 17E-D is active as a disabled requester prototype, and Phase 17E-E is active as readiness planning only with no live workflow change/)
  assert.match(qa, /Phase 17E-B closed as a dry-run-only accessRequests prototype, and Phase 17E-C \/ 17E-D \/ 17E-E keep Firestore rules and indexes undeployed/)
  assert.match(health, /Phase 17E-C is active as a read-only admin request surface, Phase 17E-D is active as a disabled requester prototype, and Phase 17E-E is active as readiness planning only with no live workflow change/)
  assert.match(health, /Phase 17E-B closed as a dry-run-only accessRequests prototype, and Phase 17E-C \/ 17E-D \/ 17E-E keep Firestore rules and indexes undeployed/)
