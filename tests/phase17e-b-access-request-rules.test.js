...
test('Phase 17E-B docs and status copy describe accessRequests as a closed dry-run prototype only', async () => {
  ...
  assert.match(qa, /Phase 17E-C, Phase 17E-D, and Phase 17E-E are closed after organizer review PASS\. Phase 17F-A, Phase 17F-B, and Phase 17F-C are closed after organizer review PASS/)
  assert.match(qa, /Phase 17E-B closed as a dry-run-only accessRequests prototype, and Phase 17E-C \/ 17E-D \/ 17E-E \/ 17F-A \/ 17F-B \/ 17F-C closed without deploying Firestore rules or indexes/)
  assert.match(health, /Phase 17E-C, Phase 17E-D, and Phase 17E-E are closed after organizer review PASS\. Phase 17F-A, Phase 17F-B, and Phase 17F-C are closed after organizer review PASS/)
  assert.match(health, /Phase 17E-B closed as a dry-run-only accessRequests prototype, and Phase 17E-C \/ 17E-D \/ 17E-E \/ 17F-A \/ 17F-B \/ 17F-C closed without deploying Firestore rules or indexes/)
