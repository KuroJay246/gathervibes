...
test('Phase 17E-B docs and current Phase 17G-B status copy keep accessRequests non-live', async () => {
  ...
  assert.match(settings, /Phase 17G-B is active on this review branch only and documents the final dry-run comparison between the current repository rules and the last deployed baseline/i)
  ...
  assert.match(qa, /Phase 17E-C, Phase 17E-D, and Phase 17E-E are closed after organizer review PASS\. Phase 17F-A, Phase 17F-B, and Phase 17F-C are closed after organizer review PASS\. Phase 17G-A is closed after organizer review PASS and the approval package is accepted\. Phase 17G-B is active on this review branch as a dry-run final review only\./)
  ...
  assert.match(health, /Phase 17E-C, Phase 17E-D, and Phase 17E-E are closed after organizer review PASS\. Phase 17F-A, Phase 17F-B, and Phase 17F-C are closed after organizer review PASS\. Phase 17G-A is closed after organizer review PASS and the approval package is accepted\. Phase 17G-B is active on this review branch as a dry-run final review only\./)
  ...
  assert.match(readme, /Phase 17G-B is active on branch `codex\/phase-17g-b-firestore-rules-deployment-final-review` from main commit `7f54a217adcac954d200a9ba7606fed521369e77` as Firestore Rules Deployment Approval \+ Dry-Run Final Review only\./)
  assert.match(handoff, /Phase 17G-B is active on branch `codex\/phase-17g-b-firestore-rules-deployment-final-review` from main commit `7f54a217adcac954d200a9ba7606fed521369e77` as Firestore Rules Deployment Approval \+ Dry-Run Final Review only\./)
