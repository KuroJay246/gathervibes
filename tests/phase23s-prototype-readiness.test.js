...
test('Phase 23T keeps organizer navigation and QA actions product-facing', async () => {
...
test('Phase 23T removes remaining organizer-facing phase and database jargon', async () => {
  const events = await readFile('src/pages/EventsPage.jsx', 'utf8')
...
test('Phase 23T current-product docs exist for organizer rehearsal, QA, deployment, and finance boundaries', async () => {
