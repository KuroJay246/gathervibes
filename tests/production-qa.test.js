...
test('QA helper creates stable CODEX_TEST prefixes and fake sample CSV rows', () => {
  ...
  assert.equal(prefix, 'QA_PHASE23S_20260622_0905')
  ...
  assert.match(csv, /QA_PHASE23S_20260622_0905 Guest One/)
  assert.match(csv, /qa_phase23s_20260622_0905_guest1@example\.com/)
...
test('System QA route and text keep production QA scoped to CODEX_TEST', async () => {
  ...
  assert.match(page, /Open Demo Event/)
