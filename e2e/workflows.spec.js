...
test('organizer can create a full planner event through the normal event wizard', async ({ page }) => {
  ...
  await dialog.getByLabel('Suppliers', { exact: true }).fill('Synthetic supplier note')
  await dialog.getByLabel('Vendors and suppliers').fill('Synthetic vendor and supplier note')
