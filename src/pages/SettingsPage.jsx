...
const ACCESS_MODEL_SECTIONS = [
  ...
  },
  {
    ...
    body: 'Phase 17G-B2 deployed Firestore rules only for the current approved accessRequests boundary and deployed a login redirect compatibility fix only. Firestore indexes are still not deployed. No permission broadening or live access-workflow write mutation is introduced in this branch. Scanner smoke is still pending before closeout.',
    rows: [
...
const ROADMAP_SECTIONS = [
  ...
  { title: '2. Current active phase', items: [
    ['Phase 17G-B2 Firestore Rules Real Deploy + Immediate Smoke', 'In progress on current branch / Firestore rules deployed / Firestore indexes not deployed / admin smoke verified / scanner smoke pending / no live workflow'],
  ...
  { title: '3. Next recommended phase', items: [['Complete Phase 17G-B2 scanner smoke + closeout', 'Do not merge until scanner smoke is completed or organizer manual scanner PASS is recorded']] },
