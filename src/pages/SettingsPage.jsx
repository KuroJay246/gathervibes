...
const ACCESS_MODEL_SECTIONS = [
  {
    ...
    body: 'Phase 17E-C closed after organizer review PASS with an admin-visible, read-only foundation for future access requests. Phase 17G-A is closed after organizer review PASS as the accepted approval package only, and Phase 17G-B is closed after organizer review PASS as the accepted final rules deployment review only. This surface documents the request shape and does not approve, decline, revoke, or submit anything.',
    rows: [
  ...
  },
  {
    ...
    body: 'No Firestore rules deploy, no Firestore index deploy, no permission broadening, and no write mutations are introduced in Phase 17G-B. This accepted final review keeps every access-workflow path non-live and records the undeployed rules boundary only.',
    rows: [
...
const ROADMAP_SECTIONS = [
  ...
  { title: '2. Current active phase', items: [
    ['Phase 17G-B Firestore Rules Deployment Approval + Dry-Run Final Review only', 'Closed after organizer review PASS / final review accepted / no Firestore rules deploy / no Firestore index deploy / no live workflow'],
