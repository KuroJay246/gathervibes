...
const ROADMAP_SECTIONS = [
  ...
  { title: '2. Current active phase', items: [['Phase 17D-A Access & Roles Planning + Scanner Day-of Polish Blueprint', 'Active planning only / no access broadening / no live workflow changes']] },
  { title: '3. Next recommended phase', items: [['Phase 17D-B or 17D-C after plan review', 'Scanner polish only or read-only Access & Roles foundation']] },
    ...
    access: (
      <SettingsSection eyebrow="Access & Roles" title="Admin allowlist and future staff access">
        <div className="rounded-2xl border border-[#E6D4B4] bg-[#FFF8EA] p-4 text-sm leading-6 text-[#715D46]">
          Approved-admin allowlist remains active owner/admin enforcement. Approved admin allowlist access remains admin-level only; approvedEmails remains admin-level access only. Do not add staff/scanners/helpers to approvedEmails. Temporary event-day helpers should not be added to approvedEmails. Phase 17D-A is active as a planning-only phase for Access & Roles and scanner day-of polish. No live approval, revoke, or lead-scanner workflow is implemented here.
        </div>
        <div className="mt-5">
