...
const ACCESS_MODEL_SECTIONS = [
  {
    ...
    body: 'Phase 17E-C closed after organizer review PASS with an admin-visible, read-only foundation for future access requests. Phase 17G-A is now the active approval package only. This surface documents the request shape and does not approve, decline, revoke, or submit anything.',
    rows: [
  ...
  },
  {
    ...
    body: 'No Firestore rules deploy, no Firestore index deploy, no permission broadening, and no write mutations are introduced in Phase 17G-A. This is an approval package only.',
    rows: [
...
const ROADMAP_SECTIONS = [
  ...
  { title: '2. Current active phase', items: [
    ['Phase 17G-A Live Workflow Go/No-Go Review + Rules Deployment Approval Package only', 'Active on this branch / no Firestore rules deploy / no Firestore index deploy / no live workflow'],
  ...
  { title: '3. Next recommended phase', items: [
    ['Organizer decision after Phase 17G-A', 'Choose 17G-B dry-run final review only, 17G-C disabled requester create workflow, or 17G-D disabled admin review workflow'],
  ] },
