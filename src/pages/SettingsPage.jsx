...
const ACCESS_MODEL_SECTIONS = [
  ...
  },
  {
    ...
    body: 'No Firestore rules deploy, no Firestore index deploy, no permission broadening, and no write mutations are introduced in Phase 17G-A. The approval package was accepted and no live workflow exists.',
    rows: [
...
const ROADMAP_SECTIONS = [
  ...
  { title: '2. Current active phase', items: [
    ['No active implementation phase on main', 'Phase 17G-A closed after organizer review PASS / approval package accepted / no Firestore rules deploy / no Firestore index deploy / no live workflow'],
  ...
  { title: '3. Next recommended phase', items: [['Phase 17G-B Firestore Rules Deployment Approval + Dry-Run Final Review only', 'No automatic real rules deploy / no index deploy unless separately approved / no live workflow until explicit organizer approval']] },
