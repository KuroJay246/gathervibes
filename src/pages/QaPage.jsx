  ...
  async function runQaChecks() {
    ...
    try {
      ...
      setQaChecks([
        ...
        { label: 'Staff roles enforcement level', status: 'pass', detail: 'Phase 17C-B remains closed and live. Phase 17D-C and Phase 17D-D are closed and merged, Phase 17E-A is closed after organizer artifact review PASS, and Phase 17E-B is closed after organizer prototype review PASS with no live workflow change.' },
        ...
        { label: 'Firestore role enforcement', status: 'pass', detail: 'Scanner/check-in-only live access is enforced through deployed rules, active staffProfiles, and active staffAssignments. Phase 17D-C and Phase 17D-D closed without changing live rules, Phase 17E-A did not deploy rules, and Phase 17E-B closed as a dry-run-only accessRequests prototype with Firestore rules still undeployed.' },
