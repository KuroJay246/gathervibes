  ...
  async function runQaChecks() {
    ...
    try {
      ...
      setQaChecks([
        ...
        { label: 'Staff roles enforcement level', status: 'pass', detail: 'Phase 17C-B remains closed and live. Phase 17D-C and Phase 17D-D are closed and merged. Phase 17E-A and 17E-B are closed. Phase 17E-C, Phase 17E-D, and Phase 17E-E are closed after organizer review PASS. Phase 17F-A, Phase 17F-B, and Phase 17F-C are closed after organizer review PASS. Phase 17G-A is closed after organizer review PASS and the approval package is accepted. Phase 17G-B is closed after organizer review PASS as the accepted final dry-run review only. No live workflow change is introduced.' },
        ...
        { label: 'Staff rules deploy status', status: 'warning', detail: 'Live scanner staff access remains on the previously deployed Phase 17C-B2 rules baseline only. Phase 17G-B does not deploy accessRequests rules or indexes; any future real rules deploy requires explicit Phase 17G-B2 authorization and immediate smoke.' },
      ])
