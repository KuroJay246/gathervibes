  ...
  async function runQaChecks() {
    ...
    try {
      ...
      setQaChecks([
        ...
        { label: 'Firestore role enforcement', status: 'pass', detail: 'Scanner/check-in-only live access is enforced through deployed rules, active staffProfiles, and active staffAssignments. Phase 17D-C and Phase 17D-D closed without changing live rules, Phase 17E-A did not deploy rules, Phase 17E-B closed as a dry-run-only accessRequests prototype, and Phase 17E-C / 17E-D / 17E-E keep Firestore rules and indexes undeployed.' },
        { label: 'Daily QA workflow status', status: 'warning', detail: 'Scheduled failures before July 2, 2026 at 12:47 UTC used main commit 1e48154 and failed the built auth smoke on stale login text expectations. The Node 20 deprecation warning was not the root cause.' },
