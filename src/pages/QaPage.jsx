  ...
  async function runQaChecks() {
    ...
    try {
      ...
      setQaChecks([
        ...
        { label: 'Staff roles enforcement level', status: 'pass', detail: 'Phase 17C-B remains closed and live. Phase 17D-B is scanner-only polish work and does not change current permissions.' },
        ...
        { label: 'Firestore role enforcement', status: 'pass', detail: 'Scanner/check-in-only live access is enforced through deployed rules, active staffProfiles, and active staffAssignments. 17D-B scanner polish does not change live rules.' },
