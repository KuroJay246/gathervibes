  ...
  async function runQaChecks() {
    ...
    try {
      ...
      setQaChecks([
        ...
        { label: 'Staff roles enforcement level', status: 'pass', detail: 'Phase 17C-B remains closed and live. Phase 17D-C is read-only/admin UI foundation only and did not change current permissions.' },
        ...
        { label: 'Firestore role enforcement', status: 'pass', detail: 'Scanner/check-in-only live access is enforced through deployed rules, active staffProfiles, and active staffAssignments. Phase 17D-C does not change live rules.' },
