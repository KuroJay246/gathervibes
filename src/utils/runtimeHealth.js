...
export function buildRuntimeHealthItems({
  ...
  return [
    ...
    },
    {
      ...
      status: 'ok',
      detail: 'Phase 17C-B remains closed and live. Phase 17D-B is scanner-only polish work and did not broaden access.',
    },
    {
    ...
    },
    {
      ...
      status: 'ok',
      detail: 'Staff profile and event assignment rules are deployed for live scanner use with CODEX_TEST-only assignment scope preserved. 17D-B scanner polish does not change rules.',
    },
    {
      label: 'Events read',
      status: eventsStatus,
