...
export function buildRuntimeHealthItems({
  ...
  return [
    ...
    },
    {
      ...
      status: 'ok',
      detail: 'Phase 17C-B remains closed and live. Phase 17D-C is read-only/admin UI foundation only and did not broaden access.',
    },
    {
    ...
    },
    {
      ...
      status: 'ok',
      detail: 'Staff profile and event assignment rules are deployed for live scanner use with CODEX_TEST-only assignment scope preserved. Phase 17D-C does not change rules.',
    },
    {
      label: 'Events read',
      status: eventsStatus,
