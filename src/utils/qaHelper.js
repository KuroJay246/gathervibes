...
export const qaChecklist = [
  ...
  'Confirm Tickets advanced filters include Pending and Review Needed',
  'Confirm Check-In filters include Group registrations, Complimentary, and Review Needed',
