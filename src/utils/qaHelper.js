...
export const qaChecklist = [
  ...
  'Confirm Registration filters include Door Paid, To Pay at Door, Missing Ticket, Missing Amount, and Review Needed',
  'Confirm Tickets filters include Door Paid, To Pay at Door, Outstanding Balance, Checked In, and Not Checked In',
  'Confirm Check-In list mode supports selected-row check-in, undo, and copy actions with confirmation',
  'Confirm Event Operations / Money Tracker opens from Dashboard and uses only the selected Working Event',
