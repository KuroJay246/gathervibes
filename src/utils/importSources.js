...
export const IMPORT_SOURCES = [
  {
    ...
    helperText: 'Download responses from Google Forms or its linked response sheet as CSV, then upload here.',
    mode: 'csv',
    fileTypes: '.csv',
    connectionStatus: 'Manual export only',
  },
  {
    ...
    group: 'Forms and spreadsheet files',
    helperText: 'Use File > Download > CSV from Google Sheets. Live Google Sheets sync is not connected.',
    mode: 'csv',
    fileTypes: '.csv',
    connectionStatus: 'Manual export only',
  },
  ...
  {
    value: 'pdf-table',
    label: 'PDF Table Downloaded From Email',
    group: 'Document',
    helperText: 'PDF table extraction is not automatic. Use the fallback guidance to export CSV/XLSX or copy table text.',
    mode: 'pdf-fallback',
    fileTypes: '.pdf',
