...
export function EmptyState({
  ...
  return (
    <div className="rounded-[24px] border border-dashed border-[#DCC8BD] bg-white px-6 py-16 text-center">
      <span className="mx-auto grid size-16 place-items-center rounded-2xl bg-[#FCEEF1] text-[#9A5260]">
      ...
      {action}
      {!action && onCreate && (
        <button type="button" onClick={onCreate} className="mt-6 rounded-xl bg-[#9A5260] px-5 py-3 text-xs font-bold text-white">
