export const TUTORIAL_TARGETS = {
  ...
  eventCategorySelector: 'event-planning-workspace',
  eventCapabilities: 'event-planning-workspace',
  eventPlanning: 'event-planning-workspace',
  registrationsSummary: 'registrations-workspace',
  registrationsAddButton: 'registrations-workspace',
  registrationFilters: 'registrations-workspace',
  paymentsSummary: 'payments-workspace',
  ticketsReadiness: 'tickets-workspace',
  checkInSearch: 'checkin-workspace',
  operationsLedgerSummary: 'operations-workspace',
  partnersSponsors: 'operations-workspace',
