# Task Status and Priority Standard

## Statuses

- To Do: work has not started.
- In Progress: work has started but is not complete.
- Completed: work is done and no longer appears as open deadline work.

## Priorities

- High: time-sensitive or blocking work.
- Medium: important organizer work that should be tracked.
- Low: useful work that is not currently blocking the event.
