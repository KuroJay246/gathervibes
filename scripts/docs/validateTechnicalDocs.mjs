...
const requiredFiles = [
  ...
  'docs/appendices/01-field-level-firestore-dictionary.md',
  'docs/appendices/02-command-safety-reference.md',
  'docs/appendices/03-route-and-feature-indexes.md',
  'docs/appendices/04-error-index-and-search-keywords.md',
  'docs/appendices/05-documentation-maintenance-procedure.md',
  ...
  'docs/runbooks/01-application-and-session-failures.md',
  'docs/runbooks/02-permission-and-access-failures.md',
  'docs/runbooks/03-scanner-ticket-and-checkin-failures.md',
  'docs/runbooks/04-import-and-data-repair.md',
  'docs/runbooks/05-development-build-and-test-failures.md',
  'docs/runbooks/06-deployment-firebase-and-project-targeting.md',
  'docs/runbooks/07-git-worktree-and-local-recovery.md',
  'docs/runbooks/08-documentation-generation-and-pdf-repair.md',
